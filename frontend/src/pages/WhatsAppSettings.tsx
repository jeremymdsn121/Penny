            ...
            <section className="rounded-2xl border border-hairline bg-surface p-6 shadow-sm">
              ...
              <div className="mt-5 border-t border-hairline pt-5">
                ...
                <label className="flex items-start gap-3">
                  ...
                  />
                  <span className="text-sm text-ink">
                    Let agents reply to Sloane by email
                    <span className="mt-0.5 block text-xs text-ink-subtle">
                      When one of your agents emails Sloane about a deal, she answers in the same
                ...
                <label className="mt-4 flex items-start gap-3">
                  ...
                  <span className="text-sm text-ink">
                    ...
                    <span className="mt-0.5 block text-xs text-ink-subtle">
                      When a buyer, seller, or other agent replies, Sloane drafts a suggested
