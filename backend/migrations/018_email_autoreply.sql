-- 018: Email as a two-way channel (Phase 1 — agents converse with Sloane by email).
--
-- Until now Sloane never replied to inbound email (Section 4 logged + nudged
...
--     agents.email row) emails Sloane on a deal, run her normal agent loop and
